...
from app.common.flame_graph import get_elided_flame_graph
from app import config


def generate_elided_flame_graph(filename, file_type, compare_filename, compare_type, start, end, compare_start, compare_end):
    ...
    return get_elided_flame_graph(flame_graph_1, flame_graph_2)
