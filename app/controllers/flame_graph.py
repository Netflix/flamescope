...
def generate_flame_graph(filename, file_type, range_start, range_end, flavor='standard'):
    ...
    if file_type == 'perf':
        ...
        return nflxprofile_generate_flame_graph(file_path, range_start, range_end, flavor == 'java-packages', flavor)
    else:
