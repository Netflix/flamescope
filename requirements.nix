...
let
  ...
  generated = self: {
    ...
    "Werkzeug" = python.mkDerivation {
      ...
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/9c/6d/854f2aa124dcfeb901815492b7fa7f026d114a18784c1c679fbdea36c809/Werkzeug-0.15.3.tar.gz"; sha256 = "cfd1281b1748288e59762c0e174d64d8bcb2b70e7c57bc4a1203c8825af24ac3"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
    ...
    "nflxprofile" = python.mkDerivation {
      name = "nflxprofile-1.0.0";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/62/b1/f79a3be9284d8fa9c5b7cd8ac43b9cbc1d8439859470ff858be675cb11a5/nflxprofile-1.0.0.tar.gz"; sha256 = "d8b88d39a87b78633b88868fb041aedd9e102946f435e63b5b00e5f4ecd52096"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."protobuf"
      ...
      meta = with pkgs.stdenv.lib; {
        homepage = "https://github.com/Netflix/nflxprofile";
